...
The cost, measured exhaustively rather than from a sample: **~1,617 symbols** drop out of a 2-character top-20 they previously reached, **952** of them live/tradeable/non-fund/≤4 chars (SNAP, MTCH, MBLY, ASAN, CELH, VICI, ARCC …). What that buys is the head of the distribution — AAPL, MSFT, AMZN, META, TSLA, AVGO, COST become reachable at two characters for the first time. **Every displaced symbol remains reachable at three characters.** Residual bias: post-2020 rows hold 34.2% of top-20 slots versus 42.4% with no age tier, while 55.5% of live tradeable non-fund rows are post-2020.
