...
Rails.application.configure do
  ...
  # Memory store (not null_store): ActionController's rate_limit counts hits in
  # the cache store, so rate limiting is untestable against a null store.
  # test_helper clears the cache between tests to keep counters isolated.
